            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 mt-4">
                        <div class="card p-3">
                            <p dir='rtl' class="mb-0 fw-bold h4">דרכי תשלום</p>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="card p-3">
                            <div class="card-body border p-0">
                                <p>
                                    <a class="sbtn btn-primary w-100 h-100 d-flex align-items-center justify-content-between"
                            ...
                            <div class="card-body border p-0">
                                <p>
                                    <a class="sbtn btn-primary p-2 w-100 h-100 d-flex align-items-center justify-content-between"
                                        data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true"
                                        aria-controls="collapseExample">
                                        <span dir='rtl' class="fw-bold">Credit Card</span>
                                        <span class="">
                                        ...
                                        <div class="col-lg-7">
                                            <form action="" class="form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="sbtn btn-primary w-100">Sumbit</div>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                    ...
                    <div class="col-12">
                        <div class="sbtn btn-primary payment">
                            Make Payment
                        </div>
                    </div>
                </div>
